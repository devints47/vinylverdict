    ...
    <div className="mb-8 flex flex-col items-center sticky top-0 z-10 w-full">
      ...
      {mainContent && (
        <Card className="mt-6 card-holographic bg-gradient-to-r from-zinc-900 to-black max-w-3xl w-full">
          ...
          <CardFooter className="border-t border-zinc-700 pt-4 pb-4 text-sm text-zinc-500 italic">
            This roast is a satirical critique generated by AI and is meant for entertainment purposes only.
          </CardFooter>
        </Card>
      )}
    </div>
